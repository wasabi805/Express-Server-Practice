...
class CreateProfile extends Component{
    ...
    componentWillReceiveProps(nextProps){
        ...
        //Check to see if the profile actually made it into state (used for edit profile)
            //profile = the actual profile state, profile = the profile obj in the state
        if(nextProps.profile.profile){

            const profile = nextProps.profile.profile;

            //Bring the skills array back to CSV (comma, separated values)
            ...
            profile.social = !isEmpty(profile.social) ? profile.social : {}; //remember : profile.social is an obj
    ...
    //All we're doing here is grabbing everything in the form from edit and passing it into this.props.createProfile
    onSubmit(e){
        e.preventDefault();
